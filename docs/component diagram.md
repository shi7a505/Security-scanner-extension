...
#### المكونات:
  ...
  ---------------------- ----------------------------- --------------------
  Extension UI           \<`<presentation>`{=html}\>   واجهة المستخدم - الـ
                                                       Popup اللي بيضغط
                                                       عليها المستخدم عشان
                                                       يبدأ الفحص

  Background Service     \<`<service>`{=html}\>        الخدمة اللي بتشتغل
                                                       في الخلفية وتراقب
                                                       الـ Tabs وتدير
                                                       العمليات

  Content Script         \<                            السكريبت اللي بيتحقن
                                                       في صفحة الويب عشان
                                                       يحلل الـ DOM والـ
                                                       Forms

  Auth Manager           \<`<security>`{=html}\>       بيدير الـ
                                                       Authentication
                                                       وبيخزن الـ JWT Token
  -------------------------------------------------------------------------
